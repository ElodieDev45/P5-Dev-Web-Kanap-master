...
function displayData(cart){
    // console.table(cart);
    // console.log(...cart);
    for (const elementsCart of cart){ /*ou */
    // cart.forEach (elementsCart => {
        console.log(elementsCart);
        
        // function htmlCartItems(){/*1-a-b-c*/
            // document.querySelector("#cart__items").innerHTML = /*1-a*//*2-a*/
            // const cartItems = document.querySelector("#cart__items");/*1-b*//*2-b*/
            // cartItems.innerHTML = /*1-b*//*2-b*/
            const cartItems = /*1-c*//*2-c*/
                ...
                // document.querySelector("#cart__items").innerHTML = cartItems; /*1-c*/
        // }/*1-a-b-c*/

        document.querySelector("#cart__items").innerHTML = cartItems;/*2-c*/

        // htmlCartItems();/*1-a-b-c*/
    ...
    //    // définition de la section parent "cart__items" /*3*/
